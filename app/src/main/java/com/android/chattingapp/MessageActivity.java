...
//        showdetail = findViewById(R.id.showdeatils);
        ...
        profile_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent (MessageActivity.this, AdminUserDetail.class);
        ...
        .addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        DatabaseReference tokens = FirebaseDatabase.getInstance().getReference().child("Tokens").child(receiver).child("token");

                        sendNotifications(usertoken, username, message, userid);
