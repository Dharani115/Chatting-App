...
public class UserDetails extends AppCompatActivity {
    TextView setting_name,setting_phone,setting_email,setting_address,setting_localaddress,setting_pin,setting_localpin,setting_age,mdob,mbloodgroup,mgender;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                setting_image.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(UserDetails.this, Imageview.class);
